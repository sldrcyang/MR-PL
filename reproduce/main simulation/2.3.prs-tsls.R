...
run_each_setting = function(setting){
  ...
  write.table(mse, paste('stimulate/results/stimulation_2/prs+uni-tsls/prs5e-08+uni-tsls.mse.setting_',setting,'.txt', sep=''), sep="\t", row.names = F, quote = F)
  write.table(coef, paste('stimulate/results/stimulation_2/prs+uni-tsls/prs5e-08+uni-tsls.coef.setting_',setting,'.txt', sep=''), sep="\t", row.names = F, quote = F)
