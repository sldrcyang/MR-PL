...
for (setting in 1:total_setting){
  ...
  write.table(mse, paste('stimulate/results/stimulation_4/multi-tsls-iwas/multi-tsls-iwas.mse.setting_',setting,'.txt', sep=''), sep="\t", row.names = F, quote = F)
  write.table(coef, paste('stimulate/results/stimulation_4/multi-tsls-iwas/multi-tsls-iwas.coef.setting_',setting,'.txt', sep=''), sep="\t", row.names = F, quote = F)
